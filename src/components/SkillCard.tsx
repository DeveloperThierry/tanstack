  ...
  return (
    <article className='feature-card island-shell rise-in rounded-3xl p-5'>
      <div className="flex items-start justify-between gap-4">
        ...
        <button className="inline-flex size-11 items-center justify-center rounded-full border border-(--line) bg-(--surface-strong) text-(--sea-ink) shadow-md" onClick={()=> setLiked((current) => !current)} type='button'>
